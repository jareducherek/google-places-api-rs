...
impl NearbySearchResult {
    pub fn to_string(&self) -> String {
        ...
        format!("NearbySearchResult {{ html_attributions: [{}], places: [{}], status: {}, error_message: {}, info_messages: [{}], next_page_token: {}, total_results: {} }}", 
            html_attributions, places, self.status, self.error_message.as_ref().unwrap_or(&"".to_string()), info_messages, self.next_page_token.as_ref().unwrap_or(&"".to_string()), self.total_results)
    }
}
...
impl FindPlaceSearchResult {
    pub fn to_string(&self) -> String {
        ...
        format!("FindPlaceSearchResult {{ results: [{}], status: {}, error_message: {}, info_messages: [{}] }}", 
            results, self.status, self.error_message.as_ref().unwrap_or(&"".to_string()), info_messages)
    }
}
...
impl TextSearchResult {
    pub fn to_string(&self) -> String {
        ...
        format!("TextSearchResult {{ html_attributions: [{}], places: [{}], status: {}, error_message: {}, info_messages: [{}], next_page_token: {} }}", 
            html_attributions, places, self.status, self.error_message.as_ref().unwrap_or(&"".to_string()), info_messages, self.next_page_token.as_ref().unwrap_or(&"".to_string()))
    }
}